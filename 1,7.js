...
let Passengers = [
    new Passenger('Name1', 1, 12389), 
    new Passenger('Name2', 2, 86976),
    new Passenger('Name3', 21, 12343), 
    new Passenger('Name4', undefined, 876434)];
...
addNewPass(new Passenger('Name5', 15, 75463));
